...
function createContext() {
    ...
    context.encodeJWT = function(object) {
        self = this;
        return jwt.sign(object, self._hash_key, {algorithm: 'HS256'});
    };
    context.decodeJWT = function(token,callback) {
        self = this;
        jwt.verify(token, self._hash_key, {algorithm: 'HS256'}, callback);
    };
    return context;
}
